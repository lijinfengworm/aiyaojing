...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'image_service' => 'getImageServiceService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '47.89.54.152', 'port' => 3306, 'dbname' => 'yaojing', 'user' => 'root', 'password' => 'margin-right:4pxsolid#EEE;', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_07003470947a446805fad0267f25c9f452718880d3f0cbc6012e55742ef9876c');
    ...
    /**
     * Gets the 'image_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\ImagesService A AppBundle\Service\ImagesService instance.
     */
    protected function getImageServiceService()
    {
        return $this->services['image_service'] = new \AppBundle\Service\ImagesService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('aa12fce34e747f6c32c66865d7d237ad029b65df');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5757939022af94.88313003')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => '47.89.54.152',
            'database_port' => 3306,
            'database_name' => 'yaojing',
            'database_user' => 'root',
            'database_password' => 'margin-right:4pxsolid#EEE;',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'aa12fce34e747f6c32c66865d7d237ad029b65df',
            'locale' => 'en',
            ...
            'kernel.secret' => 'aa12fce34e747f6c32c66865d7d237ad029b65df',
